...
<tbody>
    ...
    <tr>
        <td style="text-align:center;"><?php echo $row['id_ticket'];?></td>
        <td style="padding-left:5px;"><?php echo $row['id_order'];?></td>
        <td style="text-align:center;"><?php echo $row['name_ticket'];?></td>
        <td style="text-align:center;"><?php echo $row['age_ticket'];?></td>
        <td style="text-align:center;"><?php echo $row['seat_ticket'];?></td>
        <td style="text-align:left;"><?php echo '$'.number_format($row['price_ticket']);?></td>
    </tr>
    <?php } ?>
</tbody>
<tfoot>
