    ...
    <div class="container-fluid">
      ...
      <div class="card shadow mb-4">
        <div class="card-header py-3">
           <a href="<?= base_url('store/admin/register') ?>" class="btn btn-success pull-right" >
           Add Access Account
          </a>
        </div>
        <div class="card-body">
              ...
              <tbody>
                <?php $i=1;foreach ($admin as $row) { ?>
                  <tr>
                    ...
                    <!-- <td><a href="<?= base_url('store/home/viewadmin/'.$row['id_admin']) ?>" class="btn btn btn-info">View</a></td> -->
                  </tr>
                <?php } ?>
            </tbody>
          </table>
