    ...
    <div class="container-fluid">
      ...
      <div class="card shadow mb-4">
        <div class="card-header py-3">
          <h6 class="m-0 font-weight-bold text-primary">เพิ่มบริษัทขนส่ง</h6>
        </div>
        <div class="card-body">
          <div class="card-body">
            <div class="row">
              <div class="col-sm-12">
                <form action="<?= base_url()?>store/parcel_delivery_company/add" enctype="multipart/form-data" method="post">
								<div class="form-group">
                    <label  class="">ชื่อบริษัทขนส่ง</label>
                    <input type="text" class="form-control" name="company_name" required="" placeholder="ชื่อบริษัทขนส่ง">
                    <?= form_error('name'),'<small class="text-danger pl-3">','</small>'; ?>
                  </div>
									<div class="form-group">
                    <label  class="">รายละเอียดบริษัทขนส่ง</label>
                    <textarea type="text" class="form-control" name="description" required="" placeholder="รายละเอียด"></textarea>
                    <?= form_error('name'),'<small class="text-danger pl-3">','</small>'; ?>             
